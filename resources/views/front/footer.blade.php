            ...
            <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            <i class="fa fa-envelope"></i><a href="mailto:sales@hotelempire.com">info@teguera.com</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <i class="fa fa-skype"></i><a href="mailto:info@green.com">info@teguera.com</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-angle-right"></i>A propos de nous</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-angle-right"></i>Service</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-angle-right"></i>Nous contacter</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-angle-right"></i>Grille des propriétés</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-angle-right"></i>Article de blog</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-angle-right"></i>Détails de la propriété</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div id="full-page-search">
    ...
    <form action="#" class="search">
        ...
        <button type="button" class="btn btn-sm btn-color">Recherche</button>
    </form>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 modal-right">
                        <div class="modal-right-content bg-white">
                            ...
                            <a href="properties-details.html" class="btn btn-show btn-theme">Voir details</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="off-canvas-sidebar">
    <div class="off-canvas-sidebar-wrapper">
        ...
        <div class="off-canvas-content">
            ...
            <aside class="canvas-widget">
                <ul class="menu">
                    <li class="menu-item menu-item-has-children"><a href="index.html">Accueil</a></li>
                    <li class="menu-item"><a href="properties-grid-leftside.html">liste propriété</a></li>
                    <li class="menu-item"><a href="properties-details.html">Detail</a></li>
                    <li class="menu-item"><a href="blog-single-sidebar-right.html">Blog</a></li>
                    <li class="menu-item"><a href="about.html">Au sujet de nous</a></li>
